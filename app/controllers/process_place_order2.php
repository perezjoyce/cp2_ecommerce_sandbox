<?php
    ...
    if(isset($_SESSION['cart_session'])) {
        ...
        $shippingAddressName = $_POST['shippingAddressName'];
        ...
        $userId = $_SESSION['id'];
            ...
            $addressId = $row['id'];
                ...
                //INSERT ID TO TBL_PLACE_ORDERS
                $sql = " INSERT INTO tbl_place_orders (payment_mode_id, cart_session, transaction_code, user_id, address_id) VALUES ($paymentMethod, '$cartSession', '$transactionCode', $userId, $addressId) ";
                $result = mysqli_query($conn, $sql);
